  ...
  test.heading('Attribute Class', function () {
    ...
    test.heading('PROPERTIES', function () {
      ...
      test.heading('label', function () {
        test.example('should default to name property capitalized', 'Name', function () {
    ...
    test.heading('METHODS', function () {
      ...
      test.heading('coerce(newValue)', function () {
        ...
        test.example('coerce method basic usage', undefined, function () {
          ...
          // Date
          test.assertion(myDate.coerce('2/21/2014').getTime() === new Date('2/21/2014').getTime());
          test.assertion(myDate.coerce('2/21').getTime() === new Date('2/21/2014').getTime());
...
test.runnerModel = function (SurrogateModelClass, inheritanceTest) {
  ...
  test.heading('Model Class', function () {
    ...
    test.heading('INTEGRATION', function () {
      test.example('model validation usage demonstrated', test.asyncResponse('test3: 0'), function (testNode, returnResponse) {
