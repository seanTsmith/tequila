...
Bootstrap3PanelInterface.prototype.registerAppBar = function (self, panel) {
  ...
  var txtTitle = '' +
    '<a class="btn btn-primary" id="homeSlice1" href="javascript:app.getInterface().homeSlice(1)"><i class="fa fa-th fa-2x"></i><span class="hidden-xs">' + app.get('brand') + '</span></a>' +
    '<a class="btn btn-primary" id="homeSlice2" href="javascript:app.getInterface().homeSlice(2)"><i class="fa fa-search fa-2x"></i><span class="hidden-xs">Find</span></a>' +
    '<a class="btn btn-primary" id="homeSlice3" href="javascript:app.getInterface().homeSlice(3)"><i class="fa fa-bookmark fa-2x"></i><span class="hidden-xs">Bookmarks</span></a>' +
    '<a class="btn btn-primary" id="homeSlice4" href="javascript:app.getInterface().homeSlice(4)"><i class="fa fa-book fa-2x"></i><span class="hidden-xs">History</span></a>' +
    '<a class="btn btn-primary" id="homeSlice5" href="javascript:app.getInterface().homeSlice(5)"><i class="fa fa-info-circle fa-2x"></i><span class="hidden-xs">Info</span></a>' +
    '<a class="btn btn-primary" id="homeSlice6" href="javascript:app.getInterface().homeSlice(6)"><i class="fa fa-ellipsis-horizontal fa-2x"></i><span class="hidden-xs">More</span></a>';
...
Bootstrap3PanelInterface.prototype.toolBar = function (icon, tooltip) {
  var click = "javascript:app.getInterface().toolBarClicked('" + icon + "')";
  if (tooltip)
