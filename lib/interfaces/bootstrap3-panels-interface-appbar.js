...
Bootstrap3PanelInterface.prototype.registerAppBar = function (self, panelBody, panelTitle) {
  ...
  var txtTitle = '' +
    '<a class="btn btn-primary" id="homeSlice1" href="javascript:b3p.homeSlice(1)"><i class="fa fa-th fa-2x"></i><span class="hidden-xs">App</span></a>' +
...
Bootstrap3PanelInterface.prototype.toolBar = function (icon, tooltip) {
  var click = "javascript:this.toolBarClicked('" + icon + "')";
  if (tooltip)
...
Bootstrap3PanelInterface.prototype.homeSlice = function (num, quick) {
  ...
  switch (num) {
    ...
    case 1: // Home
      ...
      html = '<div class="">';
      for (var m in menu) {
        html += '<a class="btn ' + menu[m][2] + ' ti-shortcut-button" href="javascript:this.navPicked(\'' + menu[m][0] + '\')">';
