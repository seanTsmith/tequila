...
//  if (this.toolBar.clientWidth>1024) baseIconWidth = 118;
  console.log('toolBar width = ' + this.toolBar.clientWidth);
  console.log('baseIconWidth = ' + baseIconWidth);
  if (this.toolBar.clientWidth) {
    iconMaxFit = Math.floor(this.toolBar.clientWidth / baseIconWidth)
    console.log('iconMaxFit = ' + iconMaxFit);
  }
  ...
  console.log('iconsShowing = ' + iconsShowing);

  for (var i=1;  i<iconsShowing; i++)
