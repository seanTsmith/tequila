...
//  // Message Icon
//  this.navEmail2 = document.createElement("button");
//  this.navEmail2.className = "navbar-toggle navbar-icons";
//  this.navEmail2.innerHTML = '<a href="#" class="navbar-icons"><i class="fa fa-envelope"> <span class="badge blue-badge">999</span></a>';
//  this.navResponsiveHeader.appendChild(this.navEmail2);
//
//  // Calendar Icon
//  this.navCalendar2 = document.createElement("button");
//  this.navCalendar2.className = "navbar-toggle navbar-icons";
//  this.navCalendar2.innerHTML = '<a href="#" class="navbar-icons"><i class="fa fa-calendar"> <span class="badge blue-badge">999</span></a>';
//  this.navResponsiveHeader.appendChild(this.navCalendar2);

  // Brand
  this.navBarBrand = document.createElement("a");
  this.navBarBrand.id = "navBarBrand";
  this.navBarBrand.className = "navbar-brand";
  this.navBarBrand.innerHTML = '<a href="javascript:this.homePanel()">' + 'tequila.js' + '</a>';
...
// Render NavBar List Item
// -------------------------------------------------------------------------------------------------------------------
Bootstrap3PanelInterface.prototype.renderNavBarListItem = function (parent, label, icon) {
  var listItem = document.createElement('li');
  icon = icon || '';
  var html = '<a href="javascript:this.navPicked(\'' + label + '\')">' + icon + label + '</a>';
  console.log(html);
