...
Framework7Interface.prototype.registerAppPage = function (self, tab, action) {
  ...
  for (var menuItem = 0; menuItem < menuContents.length; menuItem++) {
    ...
    midPart += self.makeAppIcon(menuContents[menuItem]);
...
// Make App Icon
// -------------------------------------------------------------------------------------------------------------------
Framework7Interface.prototype.makeAppIcon = function (action) {
  ...
  return '<div class="col-33">' +
    '<a href="#" class="button button-round button-tall button-' + className + '">' +
