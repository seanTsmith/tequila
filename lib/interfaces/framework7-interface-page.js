...
// Add Sliding Page
// -------------------------------------------------------------------------------------------------------------------
Framework7Interface.prototype.addSlidingPage = function () {
  ...
  this.f7mainView.loadContent(
      ...
      '    <div class="center sliding">Cheers(wtf)Mate!</div>' +
      '  </div>' +
      '</div>' +
      '<div class="pages">' +
...
Framework7Interface.prototype.addPresentationPage = function (command) {
  ...
  var topPart =
    ...
    '<div class="navbar-inner">' +
    '<div class="left"><a href="#" class="back link"><i class="icon icon-back-blue"></i><span>Back</span></a></div>' +
    '<div class="center sliding">addPresentationPage</div>' +
    '</div>' +
    '</div>' +
    // top of pages
    '<div class="pages">' +
  ...
  function renderAttribute(attribute) {
    ...
    midPart += '<div class="item-title label">Name</div>';
    midPart += '<div class="item-input"><input type="text" placeholder="Your name"/></div>';
    midPart += '</div></div></li>';
  }
  ...
  function renderCommand(command) {
    ...
    midPart += '<div class="col-33"><a href="#" class="button button-'+className+'"><i class="fa '+icon+'">&nbsp</i>Button</a></div>';
