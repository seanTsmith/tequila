...
Bootstrap3PanelInterface.prototype.registerPresentationPanel = function (self, panel, action) {
  ...
  function renderAttribute(attribute) {
    ...
    var formGroup, label, inputDiv, input, helpTextDiv, sz, button, textNode;
    ...
    if (false && attribute.quickPick) {
      ...
      inputDiv.innerHTML = '<select class="form-control"><option>1</option><option>2</option><option>3</option><option>4</option><option>5</option></select>';
