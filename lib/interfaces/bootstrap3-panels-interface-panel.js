...
Bootstrap3PanelInterface.prototype.renderPanel = function (action) {
  ...
  var txtTitle = '<a href="javascript:app.getInterface().panelClicked(' + self.eleCount + ')"><i class="fa ' + icon + '"></i> ' + label + '</a>';
  ...
  if (type != 'home') {
    ...
    panelContractButton.setAttribute('href', "javascript:app.getInterface().panelContract(" + self.eleCount + ")");
    ...
    panelExpandButton.setAttribute('href', "javascript:app.getInterface().panelExpand(" + self.eleCount + ")");
    ...
    panelCloseButton.setAttribute('href', "javascript:app.getInterface().panelClose(" + self.eleCount + ")");
...
Bootstrap3PanelInterface.prototype.invokePanelHandler = function (type, panel, action) {
  for (var p in this.panelHandlers) {
