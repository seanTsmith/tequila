...
Bootstrap3PanelInterface.prototype.renderPanel = function (action) {
  ...
  var txtTitle = '<a href="javascript:b3p.panelClicked(' + this.eleCount + ')"><i class="fa ' + icon + '"></i> ' + label + '</a>';
  ...
  if (type != 'home') {
    ...
    panelContractButton.setAttribute('href', "javascript:b3p.panelContract(" + this.eleCount + ")");
    ...
    panelExpandButton.setAttribute('href', "javascript:b3p.panelExpand(" + this.eleCount + ")");
    ...
    panelCloseButton.setAttribute('href', "javascript:b3p.panelClose(" + this.eleCount + ")");
  ...
  if (!this.invokePanelHandler(type, panelBody, panelTitle, action)) {
